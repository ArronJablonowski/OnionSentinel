...
class PortalAccessPolicyTests(unittest.TestCase):
    def test_installer_deploys_access_session_and_audit_modules(self) -> None:
        ...
        for name in (
            ...
            "portal_human_identity_store.py",
            "portal_human_identity_management.py",
            "portal_human_identity_cli.py",
            "manage-human-identities.py",
    ...
    def test_modularization_contract_covers_the_access_runtime_tree(self) -> None:
        ...
        expected = {
            ...
            "onion-sentinel-dashboard/portal_human_identity_store.py",
            "onion-sentinel-dashboard/portal_human_identity_management.py",
            "onion-sentinel-dashboard/portal_human_identity_cli.py",
            "onion-sentinel-dashboard/manage-human-identities.py",
