...
test('reviewer projection preserves the exact observed route',()=>{assert.equal(p.reviewer({reviewer_model_route:'codex-cli:gpt-5.6-sol:xhigh'}).reviewer_model_route,'codex-cli:gpt-5.6-sol:xhigh');});
