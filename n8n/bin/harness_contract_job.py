...
def job_envelope_values(
    *,
    ...
    correlation_id = _correlation_id(prompt_package, case_id)
    contract = _mapping_value(prompt_package, "evidence_reference_contract")
    ...
    return {
        ...
        "alert_id": (
            valid_identifier(alert_id, "alert_id") if alert_id else ""
        ),
        "role": role,
        "task_kind": task_kind,
        "assigned_route": model_route(
            assigned_route,
