...
import portal_access_observer
import portal_access_observer_runtime
...
import portal_human_identity_store
import portal_human_identity_management
import portal_human_identity_cli
...
load_file(
    "_onion_sentinel_human_identity_management",
    dashboard_dir / "manage-human-identities.py",
)
...
cp "$REPO_DIR/operations/validate-credential-governance.py" "$STACK_DIR/bin/validate-credential-governance.py"
cp "$REPO_DIR/operations/security/credential-governance.json" "$STACK_DIR/bin/credential-governance.json"
...
cp "$REPO_DIR/n8n/bin/recovery_snapshot.py" "$STACK_DIR/bin/recovery_snapshot.py"
...
cp "$REPO_DIR/n8n/bin/investigation_skills_v2.py" "$STACK_DIR/bin/investigation_skills_v2.py"
cp "$REPO_DIR/n8n/bin/investigation_skill_registry_v2.py" "$STACK_DIR/bin/investigation_skill_registry_v2.py"
cp "$REPO_DIR/n8n/bin/investigation_skill_signing_v2.py" "$STACK_DIR/bin/investigation_skill_signing_v2.py"
cp "$REPO_DIR/n8n/bin/investigation_skill_lifecycle_v2.py" "$STACK_DIR/bin/investigation_skill_lifecycle_v2.py"
cp "$REPO_DIR/n8n/bin/investigation_skill_runtime_v2.py" "$STACK_DIR/bin/investigation_skill_runtime_v2.py"
cp "$REPO_DIR/n8n/bin/manage-investigation-skill-registry-v2.py" "$STACK_DIR/bin/manage-investigation-skill-registry-v2.py"
...
cp "$REPO_DIR/n8n/bin/endpoint_inventory_collection.py" "$STACK_DIR/bin/endpoint_inventory_collection.py"
cp "$REPO_DIR/n8n/bin/endpoint_inventory_preflight.py" "$STACK_DIR/bin/endpoint_inventory_preflight.py"
...
cp "$REPO_DIR/n8n/bin/agent_memory_context_contract.py" "$STACK_DIR/bin/agent_memory_context_contract.py"
...
cp "$REPO_DIR/onion-sentinel-dashboard/scripts/dashboard_untrusted_text.py" "$DASHBOARD_RUNTIME_DIR/scripts/dashboard_untrusted_text.py"
...
cp "$REPO_DIR/onion-sentinel-dashboard/scripts/dashboard_claim_evidence.py" "$DASHBOARD_RUNTIME_DIR/scripts/dashboard_claim_evidence.py"
...
cp "$REPO_DIR/onion-sentinel-dashboard/scripts/dashboard_cti_lifecycle_workspace.py" "$DASHBOARD_RUNTIME_DIR/scripts/dashboard_cti_lifecycle_workspace.py"
...
cp "$REPO_DIR/onion-sentinel-dashboard/portal_access_observer.py" "$DASHBOARD_RUNTIME_DIR/portal_access_observer.py"
cp "$REPO_DIR/onion-sentinel-dashboard/portal_access_observer_runtime.py" "$DASHBOARD_RUNTIME_DIR/portal_access_observer_runtime.py"
...
cp "$REPO_DIR/onion-sentinel-dashboard/portal_human_identity_store.py" "$DASHBOARD_RUNTIME_DIR/portal_human_identity_store.py"
cp "$REPO_DIR/onion-sentinel-dashboard/portal_human_identity_management.py" "$DASHBOARD_RUNTIME_DIR/portal_human_identity_management.py"
cp "$REPO_DIR/onion-sentinel-dashboard/portal_human_identity_cli.py" "$DASHBOARD_RUNTIME_DIR/portal_human_identity_cli.py"
cp "$REPO_DIR/onion-sentinel-dashboard/manage-human-identities.py" "$DASHBOARD_RUNTIME_DIR/manage-human-identities.py"
...
cp "$REPO_DIR/onion-sentinel-dashboard/portal_untrusted_text.py" "$DASHBOARD_RUNTIME_DIR/portal_untrusted_text.py"
...
cp "$REPO_DIR/onion-sentinel-dashboard/portal_claim_evidence_renderer.py" "$DASHBOARD_RUNTIME_DIR/portal_claim_evidence_renderer.py"
...
cp "$REPO_DIR/onion-sentinel-dashboard/ac_hunter_config_admission.py" "$DASHBOARD_RUNTIME_DIR/ac_hunter_config_admission.py"
...
cp "$REPO_DIR/onion-sentinel-dashboard/cti_program_lifecycle.py" "$DASHBOARD_RUNTIME_DIR/cti_program_lifecycle.py"
cp "$REPO_DIR/onion-sentinel-dashboard/cti_program_audit.py" "$DASHBOARD_RUNTIME_DIR/cti_program_audit.py"
