...
def _normalized_contradiction_factors(
...
def _append_event_contradictions(
...
def _append_disposition_contradictions(
    contradictions: list[str],
    disposition: str,
    handling: str,
) -> None:
...
def _append_duplicate_contradictions(
    contradictions: list[str],
    duplicate_of: str,
    handling: str,
) -> None:
...
def _append_false_positive_contradictions(
    contradictions: list[str],
    outcome: str,
    disposition: str,
    handling: str,
...
def adjudication_verdict_contradictions(
    ...
    event_status, validity, disposition, handling, duplicate_of = (
        _normalized_contradiction_factors(factors)
    )
    _append_event_contradictions(contradictions, event_status, validity)
    _append_disposition_contradictions(contradictions, disposition, handling)
    _append_duplicate_contradictions(contradictions, duplicate_of, handling)
    _append_false_positive_contradictions(
        contradictions, outcome, disposition, handling
    )
