...
@media(min-width:621px){.health-pcap-recent table{min-width:960px}}.health-pcap-recent td:nth-child(3)::before{content:"Outcome"}.health-pcap-recent td:nth-child(4)::before{content:"Request"}.health-pcap-recent td:nth-child(5)::before{content:"Group"}.health-pcap-recent td:nth-child(6)::before{content:"Size"}.health-pcap-recent td:nth-child(7)::before{content:"Transfer Time"}.health-pcap-recent td:nth-child(8)::before{content:"Error"}
@media(min-width:621px){.system-health-table th:nth-child(2),.system-health-table td:nth-child(2){width:126px;min-width:126px;white-space:nowrap;overflow-wrap:normal;word-break:normal}}
...
(() => {
  ...
  function renderPipelineHealth(pipeline) {
    ...
    pipelineDetails.innerHTML = `
      ...
      <div class="health-pipeline-table"><table>
