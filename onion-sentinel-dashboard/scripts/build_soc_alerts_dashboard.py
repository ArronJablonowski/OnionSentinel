...
def incident_response_page_section() -> str:
    ...
    <style>
      ...
      .ir-table{min-width:1120px}.ir-table col.ir-col-expand{width:48px}.ir-table col.ir-col-case{width:94px}.ir-table col.ir-col-escalated{width:138px}.ir-table col.ir-col-alert{width:auto}.ir-table col.ir-col-assessment{width:190px}.ir-table col.ir-col-network{width:210px}.ir-table col.ir-col-count{width:58px}.ir-table col.ir-col-agent{width:108px}.ir-table col.ir-col-actions{width:112px}.ir-table th,.ir-table td{padding:13px 10px}.ir-case-row td{background:#09141d}.ir-case-row:nth-of-type(4n+1) td{background:#0a1620}.ir-case-cell{display:grid;gap:7px;align-content:center}.ir-case-cell .ir-status{width:max-content}.ir-case-cell .ir-severity-label{font-size:.68rem;font-weight:900;letter-spacing:.04em;text-transform:uppercase}.ir-escalated{display:grid;gap:3px;white-space:normal}.ir-escalated-date{color:#d7e3ef;font-weight:780}.ir-escalated-time{color:#8397ab;font-size:.75rem}.ir-assessment-cell .review-badge-row{margin:0;align-items:flex-start}.ir-network-path{display:grid;grid-template-columns:minmax(0,1fr) 16px minmax(0,1.15fr);gap:4px;align-items:center}.ir-network-endpoint{min-width:0}.ir-network-label{display:block;margin-bottom:3px;color:#73879a;font-size:.62rem;font-weight:900;letter-spacing:.05em;text-transform:uppercase}.ir-network-value{display:block;overflow:hidden;color:#d8e7f8;font:700 11.5px/1.35 ui-monospace,SFMono-Regular,Menlo,monospace;text-overflow:ellipsis;white-space:nowrap}.ir-network-arrow{color:#35d9ec;text-align:center}.ir-count-value{display:inline-grid;min-width:34px;height:28px;padding:0 7px;place-items:center;border:1px solid #214153;border-radius:999px;color:#dffaff;background:#0b1e29;font-weight:900}.ir-agent-cell{display:grid;gap:5px;justify-items:start}.ir-agent-model{max-width:100%;overflow:hidden;color:#8195aa;font:10.5px/1.3 ui-monospace,SFMono-Regular,Menlo,monospace;text-overflow:ellipsis;white-space:nowrap}.ir-actions-cell{display:grid;gap:7px}.ir-actions-cell .review-action-button,.ir-actions-cell .ir-reanalyze-case{width:100%;min-height:32px;margin:0;padding:5px 7px;font-size:.68rem}.ir-agent{white-space:normal;line-height:1.35}.ir-agent-analysis_failed{color:#ff7088}.ir-agent-review_failed{color:#ffb15c}.ir-agent-refresh_failed{color:#ffcb67}
