...
def render_static_page(shell_html: str, page_key: str, reports: list[AlertReport]) -> str:
    ...
    rendered = re.sub(r'<nav class="nav">.*?</nav>', build_nav_html(page_key, active_count), rendered, count=1, flags=re.S)
