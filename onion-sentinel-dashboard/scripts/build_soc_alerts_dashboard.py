...
def software_inventory_page_section() -> str:
    ...
    <style>
      ...
      .software-table{table-layout:auto}.software-table th:nth-child(2),.software-table td:nth-child(2){white-space:nowrap}.software-table td:nth-child(2) .software-name{overflow-wrap:normal;word-break:normal}
    </style>
    <script>
    (()=> {
