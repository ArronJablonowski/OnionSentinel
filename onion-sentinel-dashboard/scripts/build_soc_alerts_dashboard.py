...
def asset_inventory_page_section() -> str:
    ...
    <section id="asset-inventory-view" class="view-section active asset-view" aria-label="Asset inventory">
      ...
      <div class="asset-table-wrap">
        <table class="asset-table">
          <thead><tr>
            <th>Asset</th><th>State</th><th>Current IP address</th><th>Hostname</th>
            <th>Role / platform</th><th>Criticality</th><th>Confidence</th>
            <th>From</th><th>Until</th><th>Source</th>
          </tr></thead>
          <tbody id="asset-table-body"><tr><td colspan="10" class="ir-loading">Loading known assets…</td></tr></tbody>
        </table>
      </div>
    ...
    (()=> {
      ...
      function render(){
        body.innerHTML=assets.length?assets.map(row).join(''):'<tr><td colspan="10" class="ir-loading">No current assets match this search.</td></tr>';
        body.dataset.liveRenderVersion=String(Number(body.dataset.liveRenderVersion||0)+1);
