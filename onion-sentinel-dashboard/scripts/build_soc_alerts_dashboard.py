...
.suppression-network-context{{display:flex;align-items:center;gap:8px;margin:0 0 10px;border:1px solid rgba(34,211,238,.20);border-radius:10px;padding:9px 11px;color:#dce9f8;background:rgba(34,211,238,.06);font:12px/1.35 ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,"Liberation Mono",monospace;overflow-wrap:anywhere}}
