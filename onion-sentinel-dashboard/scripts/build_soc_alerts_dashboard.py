      ...
      <div class="asset-table-wrap">
        <table class="asset-table">
          <thead><tr>
            ...
            <th>Validity</th><th>Source</th>
          </tr></thead>
          <tbody id="asset-table-body"><tr><td colspan="9" class="ir-loading">Loading known assets…</td></tr></tbody>
        </table>
      </div>
